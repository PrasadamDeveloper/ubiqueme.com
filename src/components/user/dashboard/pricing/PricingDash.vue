    ...
    <div class="relative z-10 pt-10 pb-20 px-4 sm:px-6">
      <div class="max-w-6xl mx-auto">
        ...
        <header class="text-center mb-12 space-y-5">
          ...
          <p class="max-w-xl mx-auto text-white/35 text-sm md:text-base leading-relaxed">
        ...
        <!-- Footer note -->
        <p class="text-center text-white/15 text-[9px] font-black uppercase tracking-[0.35em] mt-12 font-mono">
