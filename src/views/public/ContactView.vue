...
<template>
  <HomeLayout>
    <template #main>
      <div class="min-h-screen bg-transparent font-google-sans">
        ...
        <div class="relative overflow-hidden pt-24 pb-12 md:pb-20">
          ...
          <!-- Ambient glow -->
          <div
            class="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-orange-500/5 rounded-full blur-[120px] pointer-events-none"
            aria-hidden="true"></div>

          <div class="relative max-w-6xl mx-auto px-6 text-center">
            <div
              class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-orange-500 text-[10px] font-black uppercase tracking-[0.2em] mb-6">
        ...
        <!-- Content -->
        <div class="max-w-5xl mx-auto px-6 pb-32 bg-transparent!">

          <!-- Success Message -->
          <div v-if="sent" class="max-w-lg mx-auto text-center">
            <div class="p-10 rounded-3xl border border-emerald-200 bg-emerald-50/80">
              <div
                class="w-16 h-16 rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center mx-auto mb-5 shadow-sm">
          ...
          <!-- Form + Sidebar -->
          <div v-else class="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-10 lg:gap-14 items-start bg-transparent">
            ...
            <div>
              ...
              <form @submit.prevent="handleSubmit" class="mt-6 space-y-5">
                ...
                <!-- Autocomplete -->
                <button v-if="userStore.getFullName" type="button" @click="autoComplete"
                  ...
                  <span
                    class="material-symbols-outlined notranslate text-[15px] group-hover:scale-110 transition-transform">bolt</span>
                  Autocompletar datos
                </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      class="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1 mb-1.5 block">Nombre
                      *</label>
                  ...
                  <div>
                    <label
                      class="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1 mb-1.5 block">Correo
                      electrónico *</label>
                ...
                <div>
                  <label
                    class="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1 mb-1.5 block">Teléfono
                ...
                <div>
                  <label
                    class="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500 ml-1 mb-1.5 block">Mensaje
                    *</label>
            ...
            <div class="space-y-6 lg:sticky lg:top-28">
              <!-- Contact Info Card -->
              <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm mt-3">
                <h3 class="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400 mb-5">Información de
                  contacto</h3>
                <div class="space-y-4">
                  ...
                  <div class="flex items-start gap-3.5">
                    ...
                    <div>
                      <p class="text-[9px] font-bold uppercase tracking-[0.15em] text-slate-400 mb-0.5">Tiempo de
                        respuesta</p>
