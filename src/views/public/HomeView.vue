...
const testimonials: Testimonial[] = [
  ...
  { id: 4, initial: 'R', name: 'Roberto', city: 'Puebla', text: 'Dejé las luces del coche encendidas y me avisaron al instante. Mi batería se salvó gracias al código QR.', color: 'amber' },
  { id: 5, initial: 'A', name: 'Ana', city: 'Querétaro', text: 'Mi hijo de 5 años se perdió en el centro comercial. Alguien escaneó su pulsera QR y me llamaron en 3 minutos.', color: 'violet' },
  { id: 6, initial: 'J', name: 'José', city: 'Tijuana', text: 'Me robaron la bicicleta. La persona que la encontró escaneó el QR y recuperé mi bici en menos de 24 horas.', color: 'emerald' },
  { id: 7, initial: 'S', name: 'Sofía', city: 'Mérida', text: 'Se me quedó la ventana del coche abajo con la lluvia. Un vecino escaneó mi QR y me avisó. Alcanzé a cubrirlo.', color: 'amber' },
  { id: 8, initial: 'D', name: 'Daniel', city: 'León', text: 'En la oficina nadie sabía de quién era esa laptop. Con el QR la devolvieron a su dueño en 10 minutos.', color: 'violet' },
  ...
  { id: 10, initial: 'F', name: 'Fernando', city: 'Toluca', text: 'Iba manejando y vi una ventana abajo en un coche estacionado. Escaneé su QR y le avisé al dueño. Así debería funcionar todo.', color: 'amber' },
  { id: 11, initial: 'G', name: 'Gabriela', city: 'San Luis', text: 'Mi abuelita se salió de la casa sin que nos diéramos cuenta. Su pulsera QR permitió que la ayudaran a regresar.', color: 'violet' },
  { id: 12, initial: 'H', name: 'Héctor', city: 'Hermosillo', text: 'Dejé la puerta de mi casa abierta al salir. Un vecino vio mi QR en la entrada y me notificó. Llegué antes de que pasara algo.', color: 'emerald' },
  ...
  { id: 15, initial: 'E', name: 'Elena', city: 'Culiacán', text: 'Olvidé mi mochila en el camión. Alguien escaneó el QR y me contactó. Increíble cómo funciona.', color: 'emerald' },
  ...
  { id: 17, initial: 'N', name: 'Natalia', city: 'Veracruz', text: 'Estaba en el aeropuerto y vi una maleta sola. Escaneé el QR y el dueño apareció en segundos. Todos deberían usar esto.', color: 'violet' },
  ...
  { id: 24, initial: 'M', name: 'Miguel', city: 'Colima', text: 'Alguien golpeó mi coche estacionado y huyó. Un testigo escaneó mi QR y me mandó fotos de la placa del responsable.', color: 'emerald' },
  ...
  { id: 28, initial: 'A', name: 'Antonio', city: 'Tapachula', text: 'Puse un QR en el casco de mi moto. Cuando la grúa se la llevó, el oficial escaneó el código y me contactó. Recuperé mi moto antes de que terminara en el corralón.', color: 'amber' },
  ...
  { id: 30, initial: 'J', name: 'Jorge', city: 'Reynosa', text: 'Puse QR en las maletas de toda mi familia. En el viaje se confundió una y en 2 minutos ya sabíamos quién la tenía. Game changer.', color: 'emerald' },
  { id: 31, initial: 'L', name: 'Laura', city: 'Chetumal', text: 'Un conductor ebrio chocó mi coche estacionado. El QR me alertó y pude obtener los datos del responsable gracias al testigo que escaneó.', color: 'amber' },
