...
<template>
  <div class=" bg-[#050505] pt-2 pb-8 px-4 md:px-6 font-google-sans   overflow-hidden rounded-3xl">
      ...
      <div class="space-y-6">
        ...
        <header class="mb-2">
          ...
          <h1 class="text-3xl md:text-4xl font-black text-white tracking-tight leading-tight">
            Solicitar código QR físico
          </h1>
          <p class="text-white/40 mt-2 text-sm max-w-xl leading-relaxed">
            Complete el formulario para solicitar su código QR físico. Asegúrese de revisar los cupos disponibles y
            las opciones de personalización antes de confirmar su pedido.
          </p>
        </header>
